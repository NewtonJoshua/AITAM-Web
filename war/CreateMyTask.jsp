...
<form method="post" action="Controller">
    	<table width="80%">
    	<tr>
    		<td width="15%">Title:</td><td width="35%"><input autofocus required maxlength="100" type="text" size=40% name="title"></input>
    		</td><td width="15%">Due Date: </td><td width="20%">
    		<input required pattern="[2][0][1][0-9][-][0-1][0-9][-][0-3][0-9]" min="2015-01-01" title="yyyy-mm-dd" type="date" name="eta" id="dat"></input>
    		</td>
    	</tr><tr>
